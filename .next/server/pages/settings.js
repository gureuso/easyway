...
/* harmony import */ var lib_bus__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lib/bus */ "./lib/bus.tsx");
/* harmony import */ var lib_subway__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! lib/subway */ "./lib/subway.tsx");
...
class Settings extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  ...
  setBuses() {
    ...
    const api = new lib_bus__WEBPACK_IMPORTED_MODULE_2__["BusAPI"]();
    api.getBuses(this.props.token).then(data => {
      for (let bus of data) {
        const key = `${bus.station_id}${bus.bus_route_id}`;
        arr.push( /*#__PURE__*/Object(react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_4__["jsxDEV"])("li", {
          "data-id": bus.id,
          "data-st-id": bus.station_id,
          "data-busroute-id": bus.bus_route_id,
          "data-ord": bus.ord,
          "data-rtnm": bus.name,
          children: [bus.name, /*#__PURE__*/Object(react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_4__["jsxDEV"])("img", {
  ...
  addBusRoute(event) {
    ...
    api.createBus(name, stId, busRouteId, ord, this.props.token).then(data => {
      arr.push( /*#__PURE__*/Object(react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_4__["jsxDEV"])("li", {
        ...
        children: [name, /*#__PURE__*/Object(react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_4__["jsxDEV"])("img", {
          src: "/static/img/plus_btn_01.svg",
          onClick: this.removeBusRoute
        }, void 0, false, {
          fileName: _jsxFileName,
  ...
  setBusRoute(event) {
    ...
    api.getBusRoute(arsId).then(data => {
      ...
      for (let i in data) {
        arr.push( /*#__PURE__*/Object(react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_4__["jsxDEV"])("div", {
  ...
  removeSubwayLine(event) {
    ...
    const api = new lib_subway__WEBPACK_IMPORTED_MODULE_3__["SubwayAPI"]();
  ...
  addSubwayLine(event) {
    ...
    api.createSubway(stationName, direction, trainLineName, this.props.token).then(data => {
      arr.push( /*#__PURE__*/Object(react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_4__["jsxDEV"])("li", {
        ...
        children: [trainLineName.split(' - ')[0], /*#__PURE__*/Object(react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_4__["jsxDEV"])("img", {
          src: "/static/img/plus_btn_01.svg",
    ...
    api.getSubways(this.props.token).then(data => {
      for (let subway of data) {
        ...
        arr.push( /*#__PURE__*/Object(react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_4__["jsxDEV"])("li", {
          ...
          children: [subway.train_line_name.split(' - ')[0], /*#__PURE__*/Object(react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_4__["jsxDEV"])("img", {
            src: "/static/img/plus_btn_01.svg",
            onClick: this.removeSubwayLine
          }, void 0, false, {
            fileName: _jsxFileName,
